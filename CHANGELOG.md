...
- **2026-09-13 12:20 (EEST)** — `feat/ai-eval-runner` — The AI eval dataset gets a **static
  ...
  ([`docs/issues/0022-ai-eval-runner.md`](docs/issues/0022-ai-eval-runner.md)). Issue 0019
  ...
  in `ranked` (3, the same duplication the variety-screen issue 0021 dedupes in the UI);
  ...
  green. Merged locally (`gh` unauthenticated). Filed as 0021 and renumbered to 0022
  because a parallel session filed the variety-screen issue under the same number.
